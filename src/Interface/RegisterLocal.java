...
public class RegisterLocal extends JFrame implements Observable{
	...
	private JComboBox getCbClasificacion() {
		if (cbClasificacion == null) {
			...
			cbClasificacion.setName("Clasificaci√≥n");
				...
				public void mouseClicked(MouseEvent e) {
					try {
						...
						if (local==null) {
							...
							JOptionPane.showInternalMessageDialog(contentPane,"Local registrado", "…xito", JOptionPane.INFORMATION_MESSAGE);
						}else {
							...
							JOptionPane.showInternalMessageDialog(contentPane,"Local modificado", "…xito", JOptionPane.INFORMATION_MESSAGE);
						}
						notificar();
